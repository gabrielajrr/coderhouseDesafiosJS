...
class NuevoUsuario {
    constructor(usuario, password, presupuestoDisponible) {
        ...
        this.presupuestoDisponible = Number(presupuestoDisponible);
    }
    presupuesto() {
...
function crearUsuario() {
    ...
    const usuario = prompt(`Ingresa tu nombre de usuario`).toLocaleLowerCase();
    const password = prompt(`Ingresa tu contraseña`).toLocaleLowerCase();
...
function crearPrediccion() {
    const nombrePiloto1 = prompt(`Ingresa el Nombre del Piloto 1`).toLocaleUpperCase();
    const nombrePiloto2 = prompt(`Ingresa el Nombre del Piloto 2`).toLocaleUpperCase();
    const nombrePiloto3 = prompt(`Ingresa el Nombre del Piloto 3`).toLocaleUpperCase();
    const equipo = prompt(`Ingresa el Nombre del Equipo`).toLocaleUpperCase();
